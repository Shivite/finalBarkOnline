...
<body>
    ...
    <!--====================  End of header area  ====================-->
    <!--====================  breadcrumb area ====================-->
    <div class="breadcrumb-area bg-img" data-bg="assets/img/projects/backgrounds/all-projects.jpg">
        <div class="container">
            <div class="row">
                <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-6 col-12 section-space--bottom--30">
                                    <div class="service-grid-item service-grid-item--style2">
                                        <div class="service-grid-item__image">
                                            <div class="service-grid-item__image-wrapper">
                                                <a href="project-details.html">
                                                    <img src="assets/img/projects/luxusfloors.jpg" class="img-fluid" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="service-grid-item__content">
                                            <h3 class="title">
                                                <a href="luxus-floors.php">Luxus Floors</a>
                                            </h3>
                                            <p class="subtitle">One of our upcomming project, Booking Start...</p>
                                            <a href="luxus-floors.php" class="see-more-link">SEE MORE</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
